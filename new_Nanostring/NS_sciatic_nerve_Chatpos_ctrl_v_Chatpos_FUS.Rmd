---
title: "DE analysis of NanoString GeoMx Chat+ control vs Chat+ FUS sciatic nerve samples"
author: "Theo Killian"
date: "`r Sys.Date()`"
output:
  html_document:
...
res1 <- results(dds, contrast = c("condition", "CTRL_ChATpos", "FUS_ChATpos"), alpha = 0.05)
```
