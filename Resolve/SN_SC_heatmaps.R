## this script generates Volcanos plot of the SC ChAT+ control samples vs SN
## ChAT+ control samples as well as Heatmap of these selected genes in SC ChAT+
## control samples (4) vs SC ChAT- control samples (4):
data.frame(genes = c(
...
## save "reliably detected" gene lists
writexl::write_xlsx(x = sn_all, path = paste0("~/Documents/tmp/dacruz/202308_piol/",
