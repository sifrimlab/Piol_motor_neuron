---
title: "DE analysis of NanoString GeoMx Chat+ vs Chat- (control only) sciatic nerve samples - condition model"
author: "Theo Killian"
date: "`r Sys.Date()`"
output:
  html_document:
...
res1 <- results(dds, contrast = c("condition", "CTRL_ChATpos", "CTRL_ChATneg"),
                alpha = 0.05)
```
