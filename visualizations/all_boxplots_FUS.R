## this script is pretty much the same as the "all_boxplots.R" script, except
## that it only plots the following genes and that the bar graphsshow the
## control TDP-43 + control FUS and FUS samples, separate ones for control
## TDP-43 + control FUS and TDP-43 samples

## gene list
# c("Apod", "Cdkn1b", "Col4a2", "Eif5a", "Gpc3", "Hnrnpa2b1", "Irf3", "Lgals1",
#   "Mdh2", "Npm1", "Psmd2", "Retnlb", "Rheb", "Rnft1", "Sfpq") -> gene_list
...
NFH_1500_total_counts %>% 
  ...
  dplyr::arrange(genes) -> NFH_1500_total_counts_long
...
names(count_list) <- c("DAPI SN transversal", "DAPI SN longitudinal",
                       ...
                       "NFH vs segmentation")
writexl::write_xlsx(x = count_list, path = paste0(fp0, "all_pseudobulk_counts_subset.xlsx"))